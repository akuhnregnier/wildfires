...
def register_backend():
    """Register dill save backend for use with joblib memory."""
    register_store_backend("dill", DillStoreBackend)


class DillStoreBackend(StoreBackendBase, StoreBackendMixin):
    ...
    def get_items(self):
        ...
        for dirpath, _, filenames in os.walk(self.location):
            ...
            if is_cache_hash_dir:
                output_filename = os.path.join(dirpath, "output.dpkl")
                try:
    ...
    def load_item(self, path, verbose=1, msg=None):
        ...
        filename = os.path.join(full_path, "output.dpkl")
        ...
        logger.debug(f"Dill loading filename '{filename}'.")
    ...
    def dump_item(self, path, item, verbose=1):
        ...
        try:
            ...
            filename = os.path.join(item_path, "output.dpkl")
            ...
            def write_func(to_write, dest_filename):
                ...
                with open(dest_filename, "wb") as f:
                    dill.dump(to_write, f, protocol=-1)
